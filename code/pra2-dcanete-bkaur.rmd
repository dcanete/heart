...
+---------+-------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| sex     | = 1.01e-06  | Sí                | Podemos ver que el 43,9% de sexo "0" tuvieron heart attack, por debajo del sexo "1" con probabilidad de 56,09%                                                              |
+---------+-------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| cp      | \< 2.2e-16  | Sí                | Rechazamos la hipótesis nula y confirmamos de que la probabilidad de tener un ataque es más alto en cp=2 teniendo en consideración la grafica y estadísticas anteriores.    |
+---------+-------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| fbs     | = 0.746     | No                | No rechazamos la hipótesis nula y, por tanto, los diferentes tipos de cps tienen más o menos la misma probabilidad de tener un ataque infarto.                              |
+---------+-------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+---------+-------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| slp     | = 1.769e-11 | Sí                | Rechazamos la hipótesis nula y confirmamos de que la probabilidad de tener un ataque es más alto en slp=2 teniendo en cuenta la gráfica y las estadísticas anteriores. \|   |
+---------+-------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| caa     | \< 2.2e-16  |                   | Rechazamos la hipótesis nula y confirmamos de que la probabilidad de tener un ataque es más alto en caa=0 teniendo en cuenta la gráfica y las estadísticas anteriores. \|   |
+---------+-------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
