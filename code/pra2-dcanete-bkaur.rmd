...
Levene's test is an inferential statistic used to assess the equality of variances for a variable calculated for two or more groups. For this test, a p-value of less than 0.05 indicates that there is, in fact, enough variance in the sample to account for possible mean differences.
...
Si el resultado del fisher test nos da un p-value por debajo de su nivel de significación (p. ej., 0,05), se rechaza la hipótesis nula, o sea, que no hay relación entre las variables.
...
+---------+-------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| cp      | \< 2.2e-16  | Sí                | Rechazamos la hipótesis nula y confirmamos de que la probabilidad de tener un ataque es más alto en cp=2 teniendo en consideración la grafica y estadísticas anteriores.Tambien, gracias al test, podemos confirmar que la variable cp afecta a la variable dependiente output.    |
+---------+-------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| fbs     | = 0.746     | No                | No rechazamos la hipótesis nula y, por tanto, los diferentes tipos de cps tienen más o menos la misma probabilidad de tener un ataque infarto. Tambien, gracias al test, podemos confirmar que la variable fbs no afecta a al output de la variable dependiente.                             |
+---------+-------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| restecg | = 0.004462  | Sí                | Rechazamos la hipótesis nula y confirmamos de que la probabilidad de tener un ataque es más alto en restecg=1 teniendo en cuenta la gráfica y estadísticas anteriores. \|   | Tambien, gracias al test, podemos confirmar que la variable restecg afecta a la variable dependiente output.
+---------+-------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| exng    | = 3.438e-14 | Sí                | Rechazamos la hipótesis nula y confirmamos de que la probabilidad de tener un ataque es más alto en exng=0 teniendo en cuenta la gráfica y las estadísticas anteriores. \|  |Tambien, gracias al test, podemos confirmar que la variable exng afecta a la variable dependiente output.
+---------+-------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| slp     | = 1.769e-11 | Sí                | Rechazamos la hipótesis nula y confirmamos de que la probabilidad de tener un ataque es más alto en slp=2 teniendo en cuenta la gráfica y las estadísticas anteriores. \|   |Tambien, gracias al test, podemos confirmar que la variable slp afecta a la variable dependiente output.
+---------+-------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| caa     | \< 2.2e-16  |                   | Rechazamos la hipótesis nula y confirmamos de que la probabilidad de tener un ataque es más alto en caa=0 teniendo en cuenta la gráfica y las estadísticas anteriores. \|   |Tambien, gracias al test, podemos confirmar que la variable caa afecta a la variable dependiente output.
+---------+-------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
Ahora vamos a estudiar los atributos numéricos versus el output mediante mediante Whitney.
